...
# Write csv
df_revenues.to_csv(os.path.join(main_dir,data_files,"ab_test_revenues_wk_1.csv"))  
...
# Write csv
df_graph.to_csv(os.path.join(main_dir,data_files,"ab_test_cr_wk_1.csv"))  
