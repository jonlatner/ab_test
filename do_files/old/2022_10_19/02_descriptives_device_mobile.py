...
#Use Filter Function
df=df[(df["deviceCategory"] == "mobile")]
...
# Write csv
df_revenues.to_csv(os.path.join(main_dir,data_files,"ab_test_revenues_device_m.csv"))  
...
# Write csv
df_graph.to_csv(os.path.join(main_dir,data_files,"ab_test_cr_device_m.csv"))  
