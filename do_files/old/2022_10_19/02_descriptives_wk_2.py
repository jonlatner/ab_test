...
#Use Filter Function
df=df[(df["date"] >= 20190108)&(df["date"] <= 20190114)]
...
# Write csv
df_revenues.to_csv(os.path.join(main_dir,data_files,"ab_test_revenues_wk_2.csv"))  
...
# Write csv
df_graph.to_csv(os.path.join(main_dir,data_files,"ab_test_cr_wk_2.csv"))  
